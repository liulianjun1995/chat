...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.8.0", e = layui.$, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        status: function (i, a) {
            ...
            n = '<ul class="layui-clear layim-face-list">' + n + "</ul>", ti.face.index = t.tips(n, i, {
                tips: 1, time: 0, fixed: !0, skin: "layui-box layui-layim-face", success: function (i) {
